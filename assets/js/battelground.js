...
function update() {
  ...
  if (keys[87] || a_P1 == true) {
    if (!player1.jumping){
	  ...
	  document.getElementById("commentry").innerHTML += '<p>' + player1.name + ' has jumped' + '</p>';
    }
  ...
  if (keys[38] || a_P2 == true) {
    if (!player2.jumping){
	  ...
	  document.getElementById("commentry").innerHTML += '<p>' + player2.name + ' has jumped' + '</p>';
    }
  ...
  if (keys[65] || left_P1 == true) {                 
   if (player1.velX > -player1.speed) {
      player1.velX--;
	  player1.lastDir = "l";
	  document.getElementById("commentry").innerHTML += '<p>' + player1.name + ' has turned left' + '</p>';
   }
  }
  // player 2
  if (keys[37] || left_P2 == true) {                 
   if (player2.velX > -player2.speed) {
      player2.velX--;
	  player2.lastDir = "l";
	  document.getElementById("commentry").innerHTML += '<p>' + player2.name + ' has turned left' + '</p>';
   }
  }
  // move right
  // player 1
  if (keys[68] || right_P1 == true) {
    if (player1.velX < player1.speed) {                   
        player1.velX++;
		player1.lastDir = "r";
		document.getElementById("commentry").innerHTML += '<p>' + player1.name + ' has turned right' + '</p>';                
    }          
  }
  // player 2
  if (keys[39] || right_P2 == true) {
    if (player2.velX < player2.speed) {                   
        player2.velX++;
		player2.lastDir = "r"; 
		document.getElementById("commentry").innerHTML += '<p>' + player2.name + ' has turned right' + '</p>';               
    }          
  }
...
function hurt(victim, attacker, victimHealth) {
  document.getElementById("commentry").innerHTML += '<p>' + attacker.name + ' has attacked' + '</p>';
  sound[0].play();
...
function incKO(winner, winnerCounter) {
	//$("#commentry").innerHTML = '<p>' + winner.name + ' has won' + '</p>';
	document.getElementById("commentry").innerHTML = '<p>' + winner.name + ' has won' + '</p>';
  ++winner.kills;
